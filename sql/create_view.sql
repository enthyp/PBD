...
CREATE OR UPDATE VIEW CLIENT_STATISTICS_V AS
SELECT CLIENTS.CLIENT_ID
       CLIENT_NAME,
       SUM(VALUE)                                   AS PAYMENT_TOTAL,
       SUM(WORKSHOP_BOOKINGS.NUMBER_OF_ATTENDEES) AS Number_Of_Attendees_On_Workshop,
       SUM(CONF_DAY_BOOKINGS.NUMBER_OF_ATTENDEES) AS Number_Of_Attendees_On_Conference
FROM CLIENTS
